...
import MenuPopover from "../../MenuPopover"; // plasmic-import: UegFKpACyLa9/component
import MenuItem from "../../MenuItem"; // plasmic-import: cfoF3HKrBtOi/component
import MenuSection from "../../MenuSection"; // plasmic-import: k_bml7iuZiHM/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: xDVIYMPIKF7c/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__y8K7S)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__i7V0I)}>
            <ChevronDownIcon
