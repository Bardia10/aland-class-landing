...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: eqJ3RsKQ-zd2/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__ymOla)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__aIr0W)}>
            <Button
