...
import Radio from "../../Radio"; // plasmic-import: 4YTXDTSpiWrg/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: uNyNJae8QLpd/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__f4INr)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__fZ4J1)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__fh962)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__pJgnh)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
