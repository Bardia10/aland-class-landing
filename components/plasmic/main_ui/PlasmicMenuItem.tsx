...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: cfoF3HKrBtOi/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pmeTx)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__ldayf)}>
            <div
              className={classNames(
                projectcss.all,
