...
import sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: 3yFPI7YYlBFE/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: 1RBipevYFbc_/icon
