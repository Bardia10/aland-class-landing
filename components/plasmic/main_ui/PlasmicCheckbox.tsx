...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 8GCIwGzw7mQX/css

import SquareSvgIcon from "./icons/PlasmicIcon__SquareSvg"; // plasmic-import: NvH-1hZ35gyW/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: 9jEqs16f5PhC/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: 3axfAFLCdMHZ/icon
