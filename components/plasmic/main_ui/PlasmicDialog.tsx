...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: XDrhO3JKjqw5/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: 2D7jq9Mtq-9Z/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: KsMgH7i3f3yE/icon
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_fW_UCOi94dKY"]]: true })}
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__ikazy)}
                >
                  {"Show dialog"}
                </Button>
              ),
    ...
    >
      ...
      >
        ...
        >
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__kLptm)}>
                <div
                  className={classNames(
                    projectcss.all,
