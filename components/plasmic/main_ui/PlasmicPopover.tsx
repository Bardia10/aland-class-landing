...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: 3yFPI7YYlBFE/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: NptWyiJLlMEd/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__d7KAr)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__qeUlG)}
            label={"Open Popover"}
          />
        ),
