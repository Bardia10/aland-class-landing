...
export type TelegramLogoSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TelegramLogoSvgrepoComSvgIcon(
  props: TelegramLogoSvgrepoComSvgIconProps
) {
