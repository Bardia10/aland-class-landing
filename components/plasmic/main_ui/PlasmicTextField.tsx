...
import Label from "../../Label"; // plasmic-import: Bu9YMsXfOKMU/component
import TextInput3 from "../../TextInput3"; // plasmic-import: 3KUhZPWdKBs4/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: OtEpYTh_qrFP/component
import Description from "../../Description"; // plasmic-import: hD3X4-RF0M19/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 1zRs9XoDK91R/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__eJ6Jg, {
          [sty.freeBoxiconEnd__eJ6Jgrg35X]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__eJ6JGr7Ef3]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__eJ6JgBfX2U]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__c2WgC, {
            [sty.freeBoxiconStart__c2WgCr7Ef3]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__c2WgCBfX2U]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pMb2D)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___0L9M4, {
            [sty.freeBoxiconEnd___0L9M4Rg35X]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___0L9M4R7Ef3]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lJaW8)}
                role={"img"}
              />
            ),
