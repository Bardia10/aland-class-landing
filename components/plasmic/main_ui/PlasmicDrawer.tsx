...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: yqr6KMAWLID2/css
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_v5Uh53ZFXEZ6"]]: true })}
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__zFzvD)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
    ...
    >
      ...
      >
        ...
        >
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__o57L)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
