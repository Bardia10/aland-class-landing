...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 4YTXDTSpiWrg/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__hSxEr)}>
        <div className={classNames(projectcss.all, sty.freeBox__dVir9)} />
      </div>
      {renderPlasmicSlot({
