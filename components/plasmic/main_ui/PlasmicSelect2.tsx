...
import sty from "./PlasmicSelect2.module.css"; // plasmic-import: tn6knEOkk91K/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__odk8E)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
