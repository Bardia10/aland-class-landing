...
import sty from "./PlasmicModal.module.css"; // plasmic-import: hKNxfDzuqFgr/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_h1EohacKo5Ph"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__ttpUp)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
