...
import Checkbox2 from "../../Checkbox2"; // plasmic-import: ftGOlP3_Zcsj/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: xT8XQo2xFDoV/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__paRQq)}>
            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__dPmCr)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2___489V)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__djg7)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
