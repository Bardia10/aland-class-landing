...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: DHR81cjNHSL0/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__ynWia)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column___5TkxB)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/main_ui/images/smallJpg.jpg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__dGhFn)}>
            <h5
