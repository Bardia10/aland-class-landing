...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 6_d2y9RfodOU/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: vUPQAB4Jq1TT/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__lUhBn)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__bZuZ9)}
              />
            </React.Fragment>
          ),
          value: args.children
