...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: MMztV3PL98e0/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__wXaRn)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lkvib)}>
        <div
