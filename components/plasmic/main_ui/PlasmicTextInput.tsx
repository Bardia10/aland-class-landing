...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: WXGFD0JrVuY6/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__wrYg3)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__wtJbg)}
              role={"img"}
            />
          ),
