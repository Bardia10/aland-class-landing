...
import SliderThumb from "../../SliderThumb"; // plasmic-import: LBMYBb4QNY8E/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: J-dFbq_qSXdL/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ngfD)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__q1PiC)}>
        <div
